rm(list=ls())
source('/wynton/home/oh/jhe3/Luoma45_MAST/dge_mast_functions.R')
...
output_dir = '/wynton/home/oh/jhe3/Luoma45_MAST/' # write DGE .csvs here 
input_dir_prefix= '/wynton/home/oh/jhe3/Luoma45_MAST/45converted/'
# 2) dataset names (individual h5ad files)
datasets = c('45_CPI_colitis_CPI_only','45_CPI_colitis_healthy', '45_healthy_CPI_only')
...
merge_organs(tissues=datasets, file_id ='DGE_allcelltypes_coarse.csv', file_name='45_disease_',
