...
datasets = c('Healthy_pd1st','Healthy_pd1tnf', 'pd1st_pd1tnf')
# 3) conditions, baseline_conds, contrast_conds
condition = 'condition'
list_baseline_conds = c('Healthy','Healthy','pd1st')
list_contrast_conds = c('pd1st','pd1tnf','pd1tnf')
...
merge_organs(tissues=datasets, file_id ='DGE_allcelltypes_coarse.csv', file_name='suppression_XAUT2_Biopsies_suppression_',
